...
export const POST = async (request: Request) => {
  ...
  const result = streamText({
    ...
    - Se a criação for bem-sucedida (success: true), informe ao usuário que a reserva foi confirmada com sucesso, e apresente um resumo com os detalhes da reserva
